...
main = do args <- getArgs
          if (length(args) /= 5 && length(args) /= 0)
            ...
            then playIO (InWindow "Gomoku" (840, 700) (10, 10)) (makeColor 0.7333 0.5569 0.2509 0) 1 (initWorld 6 3 False [] Black White "normal" False "intermediate") drawWorld handleInput updateWorld
          else do
            ...
            let ai = (args!!4)
            playIO (InWindow "Gomoku" (840, 700) (10, 10)) (makeColor 0.7333 0.5569 0.2509 0) 1 (initWorld size target False [] Black player game_type True ai) drawWorld handleInput updateWorld
